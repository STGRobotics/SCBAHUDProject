...
public class InitiateSuccess : MonoBehaviour {
	...
	void Update () {
		...
		if (target == GameObject.Find("EvacPoint") && GameObject.FindWithTag("EvacPath") != null && GameObject.FindWithTag("SuccessText") == null && GameObject.FindWithTag("FailureText") == null){
